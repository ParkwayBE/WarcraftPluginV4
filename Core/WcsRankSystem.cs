...
namespace WarcraftPlugin.Core
{
    public class WcsRankSystem
    {
        ...
        private void ShowPlayerRank(CCSPlayerController player)
        {
            ...
            // Print all
            player.PrintToChat($" <font color='##FF0000'>★</font> <font color='##FFD700'>Your WCS Rank Summary</font> <font color='##FF0000'>★</font>");
        ...
        private void ShowPlayerStatsMenu(CCSPlayerController viewer, ulong steamId)
        {
            ...
            var menu = MenuManagerExtra.CreateMenu($"<font color='##FFD700'>2{name}'s WCS Stats</font>", 6);
            menu.Category = $"Player Stats";

            menu.Add($"<font color='##00FF00'>Total Level:</font><font color='##FFFF00'> {totalLevel}</font>", null, null);
            menu.Add($"<font color='##00FF00'>Total Kills:</font><font color='##FFFF00'> {totalKills}</font>", null, null);
            menu.Add($"<font color='##00FF00'>Total Deaths:</font><font color='##FFFF00'> {totalDeaths}</font>", null, null);
            menu.Add($"<font color='##00FF00'>K/D Ratio:</font><font color='##FFFF00'> {kdRatio:0.00}</font>", null, null);
            menu.Add($"<font color='##00FF00'>Most Played:</font><font color='##FFFF00'> {mostPlayedRace} ({mostPlayedKills} kills)</font>", null, null);
